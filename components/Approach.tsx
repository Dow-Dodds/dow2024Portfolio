  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card title="Design & Development Progress" 
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <h2 className="text-center text-3xl dark:text-white opacity-0 
        ...
        <h2 className="text-sm text-center dark:text-white opacity-0 
        group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4 
